...
@section('title', 'بدلات الرواتب ')

@section('contentheader', 'قائمة الضبط')

@section('contentheaderactivelink')
    <a href="{{ route('Salary_allowances.index') }}">بدلات الرواتب  </a>
@endsection
...
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title card_title_center">بيانات البدلات</h3>
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#createdepartment">
                    <i class="fa fa-plus" aria-hidden="true"></i> إضافة بدل راتب  جديد
                </button>
            </div>
            ...
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover text-center">
                    ...
                    @foreach ($data as $info)
                        ...
                        @include('Dashboard.Salary_allowances.edit')
                        @include('Dashboard.Salary_allowances.delete')
    ...
    @include('Dashboard.Salary_allowances.create')
