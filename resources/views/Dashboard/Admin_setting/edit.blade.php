    ...
    <div class="card">
        ...
        <div class="card-body">
            @if(@isset($data) and !@empty($data))
                <form action="{{ route('Admin_setting.update','test') }}" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>   الصورة</label>
                                <input type="file" name="logo" id="emp_photo" class="form-control" value="{{ old('emp_photo') }}" >
                                @error('emp_photo')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
