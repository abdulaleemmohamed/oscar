        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select name="allowance_types_id" id="edit_allowance_types_id" class="form-control select2">
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.editAbsenceBtn', function (e) {
                ...
                let allowance_types_id = $(this).data('allowance_types_id');
                ...
                $('#edit_allowance_types_id').val(allowance_types_id).trigger('change');


                // لو عايز الاسم المختار كمان
                let name = $('#edit_allowance_types_id option:selected').text();
                console.log("Selected ID:", allowance_types_id);
