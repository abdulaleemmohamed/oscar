    ...
    <div class="modal-dialog modal-fullscreen" style="width:90% !important; max-width:90% !important; ">
        <div class="modal-content" style=" border-radius:0 !important;">
            ...
            <div class="modal-header">
                <h3 class="text-lg font-bold mb-4">  تسجيل مكافة مالية  موظف شهر :{{ $finance_per->Month->name_ar}}</h3>
            ...
            <div class="modal-body">
                ...
                <div class="col-md-3  day_salary" style="display: none">
                    ...
                    <div class="col-md-3 " >
                        <div class="form-group" >
                            <label for="address">اختار نوع مكافة   </label>
                            <select name="allowance_types_id" id="allowance_types_id" class="form-control select2">
            ...
            <div class="row">
                ...
                <div class="col-md-6" >
                    <div class="form-group" >
                        <label for="address">اجمال قيمة المكافية</label>
