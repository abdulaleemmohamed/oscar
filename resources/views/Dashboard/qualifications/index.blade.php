...
@section('contentheaderactivelink')
    <a href="{{ route('departments.index') }}">المؤهلات الدراسية </a>
@endsection
...
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title card_title_center">بيانات المؤهلات الدراسية</h3>
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#createdepartment">
                    <i class="fa fa-plus" aria-hidden="true"></i> إضافة مؤهل جديد
                </button>
            </div>
            ...
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover text-center">
                    ...
                    @foreach ($data as $info)
                        ...
                        @include('Dashboard.qualifications.edit')
                        @include('Dashboard.qualifications.delete')
    ...
    @include('Dashboard.qualifications.create')
