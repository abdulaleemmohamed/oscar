        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select name="additional_types_id" id="edit_additional_types_id" class="form-control select2">
                        <option value="">اختر  </option>
                        @foreach($get_additions as $addition)
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.editAbsenceBtn', function (e) {
                ...
                let additional_types_id = $(this).data('additional_types_id');
                ...
                $('#edit_additional_types_id').val(additional_types_id).trigger('change');


                // لو عايز الاسم المختار كمان
                let name = $('#edit_additional_types_id option:selected').text();
                console.log("Selected ID:", additional_types_id);
