        ...
        <div class="modal-content" style=" border-radius:0 !important;">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-3  day_salary" style="display: none">
                    ...
                    <div class="col-md-3 " >
                        <div class="form-group" >
                            <label for="address">اختار نوع الاضافي   </label>
                            <select name="additional_types_id" id="additional_types_id" class="form-control select2">
            ...
            <div class="row">
                ...
                <div class="col-md-6" >
                    <div class="form-group" >
                        <label for="address">اجمال قيمة الاضافي</label>
