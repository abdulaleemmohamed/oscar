...
@section('title', 'انواع الوظائف')

@section('contentheader', 'قائمة الضبط')

@section('contentheaderactivelink')
    <a href="{{ route('departments.index') }}">انواع الوظائف </a>
@endsection
...
@section('content')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title card_title_center">بيانات انواع الوظائف</h3>
            ...
            <div class="card-body">
                <table id="example2" class="table table-bordered table-hover text-center">
                    ...
                    @foreach ($data as $info)
                        ...
                        @include('Dashboard.job_categories.edit')
                        @include('Dashboard.job_categories.delete')
    ...
    @include('Dashboard.job_categories.create')
