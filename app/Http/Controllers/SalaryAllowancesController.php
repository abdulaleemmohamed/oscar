...
class SalaryAllowancesController extends Controller
{
    public function index()
    {
        $data = Salary_allowances::all();
        return view('Dashboard.Salary_allowances.index',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        try {
            // إنشاء فرع جديد
            $Additional_salary = new Salary_allowances();
            ...
            return redirect()->route('Salary_allowances.index')
    ...
    {
        try{
            $branch =Salary_allowances::findorfail($request->id);
    ...
    {
        try {
            $delete_job=Salary_allowances::findorfail($request->id)->delete();
