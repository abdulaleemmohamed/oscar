...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employee_addtions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('additional_types_id')
                ->references('id')->on('additional_salaries')
                ->onUpdate('cascade')->onDelete('cascade');

            $table->decimal('total', 10, 2)
                ->comment('إجمالي الإضافي');
    ...
    {
        Schema::dropIfExists('main_salary_employee_addtions');
    }
};
